...
import OnePayment from '../../../../public/static/assets/feature/onePaymentPreview.svg'
...
import Assets from '../../../../public/static/assets/feature/assetsControlPreview.svg'
                    ...
                    <div id="slide-1" >
                        <div className="flex flex-row w-full justify-center align-middle mx-8 h-max py-14">
                            ...
                            <div className="flex flex-col justify-center align-middle">
                                <h1 className="text-left text-5xl text-primary font-bold">All in one app.<span className='text-LIGHT/onPrimaryContainer'> So you can focus on achieving your financial independence.</span></h1>
                                <div className='align-middle grid md:grid-cols-4 lg:gap-4 grid-cols-2 gap-2 mt-4'>
                                    ...
                                    <Image className='w-100 h-auto' src={OnePayment} alt="" />
