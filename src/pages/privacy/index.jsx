      ...
      <div className="w-screen sm:w-5/6">
        ...
        <section className="h-max lg:mx-6 md:mb-16 mb-8 mt-8">
          <div className="card-main bg-onPrimary bg-opacity-70 lg:px-16 lg:py-14 sm:px-12 sm:py-10 px-8 py-8">
            <h1 className="text-primary sm:text-6xl text-4xl font-bold mb-12">Privacy Policy</h1>
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                {' '}
                PT. KUDOKU FINANSIAL INDONESIA (“us”, “we”, or “our”) operates http://kudoku.id and
                Kudoku mobile application (hereinafter referred to as “Service”).
              </p>
              <p className="mb-4">
                {' '}
                Our Privacy Policy governs your visit to http://kudoku.id and Kudoku mobile
                application, and explains how we collect, safeguard and disclose information that
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                {' '}
                SERVICE means the http://kudoku.id website and Kudoku mobile application operated by
              ...
              <p className="mb-4">
                ...
                any personal data are, or are to be, processed. For the purpose of this Privacy
            ...
            <section className="mb-12">
              ...
              <p className="mb-12">
                ...
                unsubscribe link or by emailing at business@kudoku.id.
              </p>
              ...
              <p className="mb-4">
                ...
                date of birth, place of birth, passport details, citizenship, registration at place
                of residence and actual address, telephone number (work, mobile), details of
                documents on education, qualification, professional training, employment agreements,
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                {' '}
                PT. KUDOKU FINANSIAL INDONESIA uses the collected data for various purposes:
              </p>
              <ol className="mb-12">
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                {' '}
                PT. KUDOKU FINANSIAL INDONESIA will take all the steps reasonably necessary to
                ...
                country unless there are adequate controls in place including the security of your
            ...
            <section className="mb-12">
              ...
              <ol className="mb-12">
                ...
                <li className="mb-4">
                  (ii) to contractors, service providers, and other third parties we use to support
                  our business;{' '}
                </li>
                ...
                <li className="mb-4">
                  (vii) if we believe disclosure is necessary or appropriate to protect the rights,
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                ...
                to be removed from our systems, please email us at business@kudoku.id.{' '}
              </p>
              <p className="mb-4">
                {' '}
              ...
              <ol>
                ...
                <li className="mb-4">
                  ...
                  of your Personal Data in a structured, machine-readable and commonly used format;
                </li>
                <li className="mb-4">
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                {' '}
                Please note, you are entitled to ask us to provide you with this information up to
                two times in a rolling twelve-month period. When you make this request, the
                information provided may be limited to the personal information we collected about
                you in the previous 12 months.{' '}
              </p>
              <ol>
                <li className="mb-4">
                  (b) To delete your personal information. If you make this request, we will delete
                  ...
                  may be accomplished through de-identification of the information. If you choose to
                ...
                <li className="mb-4">
                  (c) To stop selling your personal information. If you submit a request to stop
            ...
            <section className="mb-12">
              ...
              <p className="mb-12">
                Fathom Analytics is analytics service provided by Conva Ventures Inc. You can find
              ...
              <p className="mb-12">
                ...
                Statcounter here: https://statcounter.com/about/legal/
              </p>
              <p className="mb-4">Flurry Analytics</p>
              <p className="mb-4">Flurry Analytics service is provided by Yahoo! Inc.</p>
              <p className="mb-4">
                You can opt-out from Flurry Analytics service to prevent Flurry Analytics from using
                and sharing your information by visiting the Flurry&apos;s Opt-out page:
                https://dev.flurry.com/secure/optOut.do
              </p>
              <p className="mb-12">
                For more information on the privacy practices and policies of Yahoo!, please visit
              ...
              <p className="mb-12">
                For more information on what type of information Unity Analytics collects, please
                visit their Privacy Policy page: hhttps://unity3d.com/legal/privacy-policy
              </p>
              ...
              <p className="mb-12">
                For more information on what type of information Yodo1 collects, please visit their
                Privacy Policy page: https://www.yodo1.com/privacy
              </p>
              <p className="mb-4">Weblate</p>
              <p className="mb-12">
                For more information on what type of information Weblate collects, please visit
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                GitLab CI (Continuous Integration) service is a part of GitLab that build and test
                the software whenever developer pushes code to application.{' '}
              </p>
              <p className="mb-4">
                GitLab CD (Continuous Deployment) is a software service that places the changes of
                every code in the production which results in every day deployment of production.{' '}
              </p>
              <p className="mb-12">
              ...
              <p className="mb-4">
                Travis CI is a distributed continuous integration service to build and test projects
                hosted at GitHub.
              </p>
              <p className="mb-12">
                For more information on what data Travis CI collects for what purpose and how the
                protection of the data is ensured, please visit Travis CI Privacy Policy page:
              ...
              <p className="mb-4">
                Bitrise is a Continuous Integration and Delivery (CI/CD) Platform as a Service with
                a main focus on mobile app development (iOS, Android, React Native, Flutter, and so
                on).{' '}
              </p>
              <p className="mb-12">
                For more information on what data Bitrise collects for what purpose and how the
                protection of the data is ensured, please visit Bitrise Privacy Notice page:
              ...
              <p className="mb-12">
                For more information on what data Fastlane collects for what purpose and how the
                protection of the data is ensured, please visit the Google Privacy Policy page:
                https://policies.google.com/privacy.{' '}
              </p>
              <p className="mb-4">Codacy</p>
              <p className="mb-4">
                Codacy is an automated code analysis/quality tool that helps developers ship better
                software, faster.{' '}
              </p>
              <p className="mb-12">
                For more information on what data Codacy collect for what purpose and how the
                protection of the data is ensured, please visit Codacy Privacy Policy page:
                https://www.codacy.com/privacy.{' '}
              </p>
              <p className="mb-4">Codecov</p>
              <p className="mb-4">
                Codecov provides highly integrated tools to group, merge, archive and compare
                coverage reports.{' '}
              </p>
              <p className="mb-12">
                For more information on what data Codecov collects for what purpose and how the
                protection of the data is ensured, please visit their Privacy Policy page:
                https://codecov.io/privacy.{' '}
              </p>
              ...
              <p className="mb-12">
                For more information on what data Codemagic collects for what purpose and how the
                protection of the data is ensured, please visit their Terms and conditions page:
                https://codemagic.io/terms/.{' '}
              </p>
              <p className="mb-4">Crowdin</p>
              <p className="mb-4">
                Crowdin is a cloud-based solution that streamlines localization management to
                effectively manage all of your multilingual content.{' '}
              </p>
              <p className="mb-12">
                For more information on what data Crowdin collects for what purpose and how the
                protection of the data is ensured, please visit Crowdin Privacy Policy page:
                https://crowdin.com/privacy-policy/#16-how-to-contact-us.{' '}
              </p>
              <p className="mb-4">CircleCI</p>
              <p className="mb-4">CircleCI is provided by Circle Internet Services, Inc. </p>
              <p className="mb-4">
                CircleCI is Continuous Integration, a development practice which is being used by
                software teams allowing them to build, test and deploy applications easier and
                quicker on multiple platforms.{' '}
              </p>
              <p className="mb-12">
                For more information on what data Circle CI collects for what purpose and how the
                protection of the data is ensured, please visit Circle CI Privacy Policy page:
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                ...
                to our users based on their visit to our Service or other websites on the Internet.
              </p>
              <p className="mb-12">
                You may opt out of the use of the DoubleClick Cookie for interest-based advertising
              ...
              <p className="mb-4">
                You can opt-out from the AdMob by Google service by following the instructions
              ...
              <p className="mb-12">
                ...
                “How Google uses data when you use our partners&apos; sites or app” page:
                http://www.google.com/policies/privacy/partners/ or visit the Privacy Policy of
            ...
            <section className="mb-12">
              ...
              <p className="mb-12">
                PT. KUDOKU FINANSIAL INDONESIA uses remarketing services to advertise on third party
                websites to you after you visited our Service. We and our third-party vendors use
              ...
              <p className="mb-4">
                ...
                Track” functionality of your web browser or by following Pinterest instructions:
            ...
            <section className="mb-12">
              ...
              <ol>
                ...
                <li className="mb-4">
                  Klarna:
                  <p>
                    Their Services Terms, Privacy Policy and Buyer Protection Policy can be viewed
                    at https://www.klarna.com/us/legal/{' '}
                  </p>
                </li>
                <li className="mb-4">
                  Moneris:
                ...
                <li className="mb-4">
                  Plaid:
                  <p>
                    Their End User Privacy Policy, Cookie Policy and Privacy Statement can be viewed
                    at https://plaid.com/legal/{' '}
                  </p>
                </li>
                <li className="mb-4">
                  Sage Pay:
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                ...
                the change becoming effective and update “effective date” at the top of this Privacy
                Policy.
              </p>
              <p className="mb-4">
