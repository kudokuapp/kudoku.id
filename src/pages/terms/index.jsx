		...
		<div className="flex md:flex-none">
			...
			<div className="w-screen sm:w-5/6">
				...
				<div className="bg-white p-14 rounded-3xl drop-shadow-md my-12 mx-6">
					<h1 className="text-primary text-6xl font-bold mb-12">
						Terms of Service
					</h1>
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							...
							use of our web pages located at http://kudoku.id and our mobile
							application Kudoku (together or individually “Service”) operated
							by PT. KUDOKU FINANSIAL INDONESIA.
						</p>
						<p className="mb-4">
						...
						<p className="mb-4">
							...
							business@kudoku.id so we can try to find a solution. These Terms
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							...
							cancel it or PT. KUDOKU FINANSIAL INDONESIA cancels it. You may
							cancel your Subscription renewal either through your online
							account management page or by contacting PT. KUDOKU FINANSIAL
							INDONESIA customer support team.
						</p>
						<p className="mb-4">
							A valid payment method, including credit card or PayPal, is
							required to process the payment for your subscription. You shall
							provide PT. KUDOKU FINANSIAL INDONESIA with accurate and complete
							...
							PT. KUDOKU FINANSIAL INDONESIA to charge all Subscription fees
							incurred through your account to any such payment instruments.
						</p>
						<p className="mb-4">
							Should automatic billing fail to occur for any reason, PT. KUDOKU
							FINANSIAL INDONESIA will issue an electronic invoice indicating
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							PT. KUDOKU FINANSIAL INDONESIA may, at its sole discretion, offer
						...
						<p className="mb-4">
							...
							Trial, you will not be charged by PT. KUDOKU FINANSIAL INDONESIA
						...
						<p className="mb-4">
							At any time and without notice, PT. KUDOKU FINANSIAL INDONESIA
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							PT. KUDOKU FINANSIAL INDONESIA, in its sole discretion and at any
						...
						<p className="mb-4">
							PT. KUDOKU FINANSIAL INDONESIA will provide you with a reasonable
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							We issue refunds for Contracts within seven (7) days of the
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							...
							exclusive property of PT. KUDOKU FINANSIAL INDONESIA and its
							licensors. Service is protected by copyright, trademark, and other
							laws of foreign countries. Our trademarks and trade dress may not
							be used in connection with any product or service without the
							prior written consent of PT. KUDOKU FINANSIAL INDONESIA.
						</p>
					</section>
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							...
							via email to kotakhukum@gmail.com, with the subject line:
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							...
							<Link href="mailto: kotakhukum@gmail.com">
								{" "}
								kotakhukum@gmail.com
							</Link>
						</p>
					</section>
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							You may provide us either directly at business@kudoku.id or via
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							...
							that are not owned or controlled by PT. KUDOKU FINANSIAL
							INDONESIA.
						</p>
						<p className="mb-4">
							PT. KUDOKU FINANSIAL INDONESIA has no control over, and assumes no
						...
						<p className="mb-4">
							YOU ACKNOWLEDGE AND AGREE THAT PT. KUDOKU FINANSIAL INDONESIA
