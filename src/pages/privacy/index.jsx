			...
			<div className="w-screen sm:w-5/6">
				...
				<div className="bg-white p-14 rounded-3xl drop-shadow-md my-12 mx-6">
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							{" "}
							PT. KUDOKU FINANSIAL INDONESIA (“us”, “we”, or “our”) operates
							http://kudoku.id and Kudoku mobile application (hereinafter
							referred to as “Service”).
						</p>
						<p className="mb-4">
							{" "}
							Our Privacy Policy governs your visit to http://kudoku.id and
							Kudoku mobile application, and explains how we collect, safeguard
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							{" "}
							SERVICE means the http://kudoku.id website and Kudoku mobile
							application operated by PT. KUDOKU FINANSIAL INDONESIA.
						</p>
						<p className="mb-4">
							{" "}
					...
					<section className="mb-12">
						...
						<p className="mb-12">
							...
							or by emailing at business@kudoku.id.
						</p>
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							{" "}
							PT. KUDOKU FINANSIAL INDONESIA uses the collected data for various
							purposes:
						</p>
						<ol className="mb-12">
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							{" "}
							PT. KUDOKU FINANSIAL INDONESIA will take all the steps reasonably
					...
					<section className="mb-12">
						...
						<ol className="mb-12">
							...
							<li className="mb-4">
								(ii) to contractors, service providers, and other third parties
							...
							<li className="mb-4">
								(iv) for the purpose of including your company&apos;s logo on
								our website;
							</li>
							<li className="mb-4">
					...
					<section className="mb-12">
						...
						<ol>
							...
							<li className="mb-4">
								(c) To stop selling your personal information. If you submit a
								request to stop selling your personal information, we will stop
								selling it. If you are a California resident, to opt-out of the
								sale of your personal information, click “Do Not Sell My
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							...
							visit this page: https://mixpanel.com/optout/
						</p>
						<p className="mb-12">
						...
						<p className="mb-12">
							For more information on what type of information Yodo1 collects,
							please visit their Privacy Policy page:
							https://www.yodo1.com/privacy
						</p>
						<p className="mb-4">Weblate</p>
						<p className="mb-12">
							For more information on what type of information Weblate collects,
							please visit their Privacy Policy page:
					...
					<section className="mb-12">
						...
						<p className="mb-4">
							Travis CI is a distributed continuous integration service to build
							and test projects hosted at GitHub.
						</p>
						<p className="mb-12">
							For more information on what data Travis CI collects for what
							purpose and how the protection of the data is ensured, please
							visit Travis CI Privacy Policy page:
						...
						<p className="mb-4">
							...
							as a Service with a main focus on mobile app development (iOS,
							Android, React Native, Flutter, and so on).{" "}
						</p>
						<p className="mb-12">
							For more information on what data Bitrise collects for what
							purpose and how the protection of the data is ensured, please
							visit Bitrise Privacy Notice page: https://www.bitrise.io/privacy.{" "}
						</p>
						...
						<p className="mb-12">
							For more information on what data Codacy collect for what purpose
							and how the protection of the data is ensured, please visit Codacy
							Privacy Policy page: https://www.codacy.com/privacy.{" "}
						</p>
						<p className="mb-4">Codecov</p>
						<p className="mb-4">
							Codecov provides highly integrated tools to group, merge, archive
							and compare coverage reports.{" "}
						</p>
						<p className="mb-12">
							For more information on what data Codecov collects for what
							purpose and how the protection of the data is ensured, please
							visit their Privacy Policy page: https://codecov.io/privacy.{" "}
						</p>
						<p className="mb-4">Codemagic</p>
						<p className="mb-4">Codemagic is provided by Nevercode LTD.</p>
						<p className="mb-4">
							Codemagic is the official CI/CD solution dedicated just for
							Flutter apps.{" "}
						</p>
						<p className="mb-12">
							For more information on what data Codemagic collects for what
							purpose and how the protection of the data is ensured, please
							visit their Terms and conditions page:
							https://codemagic.io/terms/.{" "}
						</p>
						<p className="mb-4">Crowdin</p>
						<p className="mb-4">
							Crowdin is a cloud-based solution that streamlines localization
							management to effectively manage all of your multilingual content.{" "}
						</p>
						<p className="mb-12">
							For more information on what data Crowdin collects for what
							purpose and how the protection of the data is ensured, please
							visit Crowdin Privacy Policy page:
					...
					<section className="mb-12">
						...
						<p className="mb-12">
							...
							http://www.google.com/policies/privacy/partners/ or visit the
						...
						<p className="mb-4">
							...
							instructions as described by Unity Technologies on their Privacy
					...
					<section className="mb-12">
						...
						<p className="mb-12">
							PT. KUDOKU FINANSIAL INDONESIA uses remarketing services to
					...
					<section className="mb-12">
						...
						<ol>
							...
							<li className="mb-4">
								Klarna:
								<p>
									Their Services Terms, Privacy Policy and Buyer Protection
									Policy can be viewed at https://www.klarna.com/us/legal/{" "}
								</p>
							</li>
							<li className="mb-4">
								Moneris:
