export const id = {
	section1: {
		reach: "Raih impian finansial Anda dengan Kudoku.",
		potential: "Memaksimalkan potensi finansial Anda sepenuhnya.",
		invite: "Dapatkan undangan Anda sekarang!",
		policy:
			"Dengan mengklik tombol, Anda setuju dengan Kebijakan Privasi kami.",
		rolling: "Bergulir saat menyenangkan untuk digunakan",
		coming: "Datang ke perangkat Web, Android, dan Apple.",
	},
	section2: {
		finansialApp:
	...
	section8: {
		left: {
			...
			description:
				"Follow our journey building Kudoku in public. We regularly share progress, successes and failures so you can learn with us!",
		},
		right: {
